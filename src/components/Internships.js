      ...
      <Container>
        <Parallax position="top">
          ...
          <p className="internships__text">
            ...
            (socjologia, ekonomia, zarządzanie, marketing, dziennikarstwo) , jak
            i ścisłych (np. matematyka). Umożliwiamy odbycie zarówno staży
            współfinansowanych ze środków Powiatowych Urzędów Pracy, czy
            programów prowadzonych w ramach biur karier. Pozostałym osobom,
            które pozytywnie przejdą proces rekrutacyjny oferujemy również
            możliwość odbycia firmowego stażu płatnego. Zachęcamy także do
            odbycia praktyki studenckiej, bądź absolwenckiej. Po przeszkoleniu i
            okresie próbnym otrzymasz szansę zostania naszym stałym
            pracownikiem.
          </p>
          ...
          <ul className="internships__button">
            <li className="internships__button-item">
              Jeśli choć na jedno z powyższych pytań Twoja odpowiedź brzmi:
              „tak”, aplikuj do nas już dziś!
            </li>
            <li className="internships__button-item">
