      ...
      <Container>
        ...
        <p className="depcontent__text">
          ...
          <strong>
            ...
            pasjonatem branży badawczej, który umożliwi podejmowanie nam jeszcze
            większej ilości równolegle realizowanych projektów.
          </strong>
        </p>
        ...
        <ul className="depcontent__list">
          ...
          <li className="depcontent__list-item">
            dobra teoretyczna i praktyczna znajomość zagadnień metodologicznych
            związanych z badaniami marketingowymi (warunek konieczny) oraz
            obszaru metodologii badań społecznych (mile widziane),
          </li>
          <li className="depcontent__list-item">
            przynajmniej kilkumiesięczne, potwierdzone doświadczenie praktyczne
            w koordynacji terenowej badań przy użyciu siatki ankieterskiej i/lub
            audytorskiej (fieldwork)
          </li>
          <li className="depcontent__list-item">
            potwierdzone minimum 3 letnie doświadczenie praktyczne na stanowisku
            specjalisty ds. badań i analiz lub równoważnym w firmie badawczej
            lub konsultingowej,
          </li>
          <li className="depcontent__list-item">
        ...
        <ul className="depcontent__list">
          ...
          <li className="depcontent__list-item">własne zasoby ankieterskie,</li>
          <li className="depcontent__list-item">
