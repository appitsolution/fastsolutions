            ...
            <div class="entry-content clear" itemprop="text">
              ...
              <ol>
                <li>
                  ...
                  adresem url:&nbsp;<strong>fastsolutions.pl</strong>
                </li>
                <li>
                  Operatorem serwisu oraz Administratorem danych osobowych jest:
                  Grupa WW sp. z o.o., siedziba: Plac Jana Kilińskiego 2, 35-005
                  Rzeszów
                </li>
                <li>
              ...
              <ol>
                ...
                <li>
                  Dane rejestrowe firmy hostingowej: H88 S.A. z siedzibą w
                  Poznaniu, Franklina Roosevelta 22, 60-829 Poznań, wpisana do
                  Krajowego Rejestru Sądowego przez Sąd Rejonowy Poznań – Nowe
                  Miasto i Wilda w Poznaniu, Wydział VIII Gospodarczy Krajowego
                  Rejestru Sądowego pod nr KRS 0000612359, REGON 364261632, NIP
                  7822622168, kapitał zakładowy 210.000,00 zł w pełni wpłacony.
                </li>
                <li>
                  Pod adresem&nbsp;
                  <a href="https://hekko.pl/">https://hekko.pl</a>&nbsp;możesz
                  dowiedzieć się więcej o hostingu i sprawdzić politykę
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      stosuje środki ochrony przed utratą danych (np. macierze
                      dyskowe, regularne kopie bezpieczeństwa),
                    </li>
                    <li>
                      stosuje adekwatne środki ochrony miejsc przetwarzania na
                      wypadek pożaru (np. specjalne systemy gaśnicze),
                    </li>
                    <li>
                      stosuje adekwatne środki ochrony systemów przetwarzania na
                      wypadek nagłej awarii zasilania (np. podwójne tory
                      zasilania, agregaty, systemy podtrzymania napięcia UPS),
                    </li>
                    <li>
                      stosuje środki fizycznej ochrony dostępu do miejsc
                      przetwarzania danych (np. kontrola dostępu, monitoring),
                    </li>
                    <li>
                      stosuje środki zapewnienia odpowiednich warunków
                      środowiskowych dla serwerów jako elementów systemu
                      przetwarzania danych (np. kontrola warunków
                      środowiskowych, specjalistyczne systemy klimatyzacji),
                    </li>
                    <li>
                      stosuje rozwiązania organizacyjne dla zapewnienia możliwie
                      wysokiego stopnia ochrony i poufności (szkolenia,
              ...
              <ol>
                ...
                <li>
                  ...
                  podstaw do przetwarzania, nadrzędnych wobec Ciebie interesów,
                  praw i wolności, w szczególności ustalenia, dochodzenia lub
                  obrony roszczeń.
                </li>
                <li>
