    ...
    <section className="rules">
      <Container>
        <ParallaxY position="left">
          ...
          <ul className="rules__notification">
            ...
            <li className="rules__notification-item">
              Jak wszyscy lubimy kiedy Klienci do nas wracają i rekomendują
              nasze usługi do kolejnych klientów
              <img
                src={Rectangle2}
                className="rules__notification-item-img"
                alt="rectangle"
      ...
      <ParallaxY position="left">
        <ul className="rules__list-message">
          ...
          <li className="rules__list-message-item">
            Zachowujemy wysokie standardy jakości i rzetelności wykonywanych
            przez nas usług badawczych
          </li>
          <li className="rules__list-message-item">
          ...
          <li className="rules__list-message-item">
            Rygorystycznie przestrzegamy zasad poufności badań i ochrony
            tajemnicy handlowej
          </li>
          <li className="rules__list-message-item">
