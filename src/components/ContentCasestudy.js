    ...
    <section className="contentcasestudy">
      <Container>
        <h1 className="contentcasestudy__head">
          ...
          rehabilitacyjnego i medycznego. Jeden z największych dystrybutorów na
        ...
        <p className="contentcasestudy__text">
          ...
          grup docelowych – aptek i sklepów medycznych działających na lokalnym
          rynku. W ramach projektu przeprowadziliśmy diagnozę poziomu
          ...
          poznaniu opinii respondentów na temat jakości świadczonych usług oraz
          powodzenia i możliwości dalszej współpracy. Biorąc pod uwagę, iż
          klientowi zależało także na rozpoznaniu, jak oceniana jest firma w
          zakresie potencjału konkurencyjności – w narzędziu badawczym
