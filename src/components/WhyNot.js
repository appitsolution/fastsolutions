          ...
          <div className="whynot__block">
            <div className="whynot__block-content">
              ...
              <p className="whynot__block-content-text">
                Wiemy, że sukcesy nie są dziełem przypadku i dlatego nasza firma
                badawcza w nawet najprostsze z powierzonych projektów angażuje
                się z całą energią. Nie zapominamyo dążeniu do ciągłego rozwoju
                i szkoleniach naszych wszystkich współpracowników:
              </p>
            ...
            <div className="whynot__block-notification">
              <p className="whynot__block-notification-text">
                Przewagą naszej agencji badawczej{" "}
                <span className="whynot__block-notification-text-span">
                  jest kompleksowość usług i wieloletnie doświadczenie
                  realizacyjne
                </span>
                <img
                  src={RectanglTest}
                  className="whynot__block-notification-text-img"
                  alt="Rectangl"
                />
              </p>
            </div>
