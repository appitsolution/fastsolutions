      ...
      <Container>
        <Parallax position="right">
              ...
              <li className="ofirma__push-list-item">
                ...
                <p className="ofirma__push-list-item-text">
                  ...
                  <span className="ofirma__push-list-item-text-span">
                    prowadzimy realizacje badań na terenie wszystkich województw
                    w kraju.
                  </span>
                </p>
              </li>
          ...
          <p className="ofirma__text">
            ...
            podwykonawcą badań społecznych dla instytucji administracji
            państwowej i samorządowej oraz instytucji otoczenia biznesu.
          </p>
          <p className="ofirma__text">
            Jako{" "}
          ...
          <p className="ofirma__text">
            ...
            <span className="ofirma__text-span">
              PGNiG S.A., Polska Spółka Gazownictwa S.A, CEFARM S.A., ARRIVA sp.
              z o.o., LIDL sp. z o.o. sp.k., Open Life Towarzystwo Ubezpieczeń
              Życie S.A., SANBank i wielu innych.
            </span>{" "}
          ...
          <ul className="ofirma__list">
            <li className="ofirma__list-item">
              <img
                src={teacher}
                className="ofirma__list-item-img"
                alt="icon1"
              />
          ...
          <p className="ofirma__text">
            ...
            działającąw obszarze content marketingu i analityki internetowej.
            Jako spółka jesteśmy również członkiem{" "}
            <span className="ofirma__text-span">
