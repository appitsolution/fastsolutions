        ...
        <ul className="socialservices__list">
          <li className="socialservices__list-item">
            ...
            <p className="socialservices__list-item-text">
              ...
              państwowych i samorządowych, w tym zarówno szczebla wojewódzkiego,
              jak i ministerialnego.Jako podwykonawcy uczestniczyliśmy w blisko
              30 projektach badawczych dotyczących tematyki społecznej.Ponadto,
              jako główni wykonawcy, realizowaliśmy kilka badań dla Klientów
              końcowych.
            </p>
          </li>
          <li className="socialservices__list-item">
            ...
            <p className="socialservices__list-item-text">
              Do badań stosujemy szeroki zakres ilościowych i jakościowych metod
              badawczych, które idealnie sprawdzają się przy badaniach
              społecznych. Stosujemy zarówno ankiety papierowe (PAPI),
              wspomagane komputerowo (CAWI) i telefoniczne (CATI), jak również
              indywidualne wywiady pogłębione (IDI) oraz wywiady grupowe (FGI).
            </p>
          </li>
        </ul>
      </Container>
