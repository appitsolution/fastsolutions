    ...
    <section className="permanentteam">
      <Container>
        ...
        <h1 className="permanentteam__head">
          ABM Fast Solutions jest agencją badawczo-marketingową, specjalizującą
          się w realizacji badań rynkowych, marketingowych i społecznych, a
          także szeroko rozumianej analizie danych zastanych.
        </h1>
        <p className="permanentteam__text">
          ...
          danych osobowych prosimy zapoznać się z polityką przetwarzania danych
          osobowych w naszej firmie dostępną tutaj.
        </p>
