...
;(function (b, c, d, e) {
  b.fn.CanvasJSChart = function (a) {
    ...
    return this.first()
      .children(".canvasjs-chart-container")
      .data("canvasjsChartRef")
  }
})(jQuery, window, document)

/*
 CanvasJS HTML5 & JavaScript Charts - v3.4.12 GA - https://canvasjs.com/ 
 Copyright 2022 fenopix
...
;(function () {
  ...
  function Va(h, n, v) {
    "millisecond" === v
      ...
      : "year" === v && h.setFullYear(h.getFullYear() + 1 * n)
    return h
  }
  function W(h, n) {
    var v = !1
  ...
  function Fa(h) {
    if (!h) return h
    h = h.replace(/^\s\s*/, "")
    for (var n = /\s/, v = h.length; n.test(h.charAt(--v)); );
    return h.slice(0, v + 1)
  }
  function Ba(h) {
    h.roundRect = function (h, v, s, w, ra, E, y, F) {
      y && (this.fillStyle = y)
      ...
      this.beginPath()
      this.moveTo(h + ra, v)
      this.lineTo(h + s - ra, v)
      this.quadraticCurveTo(h + s, v, h + s, v + ra)
      this.lineTo(h + s, v + w - ra)
      this.quadraticCurveTo(h + s, v + w, h + s - ra, v + w)
      this.lineTo(h + ra, v + w)
      this.quadraticCurveTo(h, v + w, h, v + w - ra)
      this.lineTo(h, v + ra)
      this.quadraticCurveTo(h, v, h + ra, v)
      this.closePath()
      y && this.fill()
      F && 0 < E && this.stroke()
    }
  ...
  function eb(h) {
    if (S.fSDec)
      h[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
        S._fTWm && S._fTWm(h)
      })
  }
  function Wa(h, n, v) {
  ...
  function N(h, n) {
    ...
    if (
      ...
      for (var s = 0; s < v.length; s++) v[s] *= n
    else v = []
    return v
  }
  function J(h, n, v, w, qa) {
    w = w || []
    qa = s(qa) ? (fb ? { passive: !1, capture: !1 } : !1) : qa
    w.push([h, n, v, qa])
    return h.addEventListener
      ? (h.addEventListener(n, v, qa), v)
      : h.attachEvent
      ? ((w = function (n) {
          n = n || window.event
          n.preventDefault =
  ...
  function hb(h) {
    if (!ib) {
      ...
      "undefined" === typeof pa.Chart.creditHref
        ? ((h.creditHref = ga("iuuqr;..b`ow`rkr/bnl.")),
          (h.creditText = ga("B`ow`rKR/bnl")))
  ...
  function va(h, n, v) {
    ...
    n.getAttribute("state") !== v &&
      (n.setAttribute("state", v),
      ...
      n.setAttribute("title", h._cultureInfo[v + "Text"]),
      (n.innerHTML =
  ...
  function ia(h, n) {
    ia.base.constructor.call(this, "TextBlock", null, n, null, null)
    this.ctx = h
    this._isDirty = !0
  ...
  function Sa(h, n) {
    Sa.base.constructor.call(this, "Toolbar", "toolbar", n, null, h)
    this.chart = h
  ...
  function Ha(h, n, v) {
    Ha.base.constructor.call(this, "Subtitle", "subtitles", n, v, h)
    this.chart = h
    this.canvas = h.canvas
    this.ctx = this.chart.ctx
  ...
  function Ia(h) {
    var n
    h && Ja[h] && (n = Ja[h])
    Ia.base.constructor.call(this, "CultureInfo", null, n, null, null)
  }
  var Ga = !1,
    S = {},
  ...
  ;(function () {
    S.fSDec = function (h) {
      for (var n = "", v = 0; v < h.length; v++)
        n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v))
      return n
    }
    ...
    S._fTWm = function (h) {
      if ("undefined" === typeof S.pro.sCH && !bb)
        try {
          ...
          v =
            "cm" === S.pos[n] || "um" === S.pos[n]
              ? 0
              : h.width -
                w[S.fSDec("ld`rtsdUdyu")](S.fSDec("B`ow`rKR!Ush`m")).width
          s = "um" === S.pos[n] ? 0 : h.height - 11
          w[S.fSDec("ghmmUdyu")](S.fSDec("B`ow`rKR!Ush`m"), v, s)
          "cs" === S.pos[n] &&
            (h[S.fSDec("^bsdehuMhoj")].style.right = S.fSDec("`tun"))
        } catch (y) {}
    }
  })()
  var fb = (function () {
        ...
        return (M = N.replace(h, function (l) {
          switch (l) {
            ...
            case "K":
              return S
                ? "UTC"
                : (String(F).match(y) || [""]).pop().replace(E, "")
            case "z":
        ...
        if (((n = F[K]), "." === n && 0 > N)) N = K
          ...
          if ("%" === n) E *= 100
            ...
            ("E" !== n[0] && "e" !== n[0]) ||
              ...
              (S = !0)
          0 > N
            ? (M.push(n), "#" === n || "0" === n ? P++ : "," === n && R++)
            : (H.push(n), ("#" !== n && "0" !== n) || J++)
        }
      S &&
        ((n = Math.floor(h)),
        (F = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (U = 0 === h ? 0 : 0 === n ? -(P + F) : String(n).length - P),
        (E /= Math.pow(10, U)))
      0 > N && (N = K)
      E = (h * E).toFixed(J)
      n = E.split(".")
        ...
        if (((n = M.pop()), "#" === n || "0" === n))
          if ((N++, N === P)) {
            var V = E,
              E = []
            if ("0" === n)
              for (n = P - J - (V ? V.length : 0); 0 < n; ) V.unshift("0"), n--
            for (; 0 < V.length; )
              (v = V.pop() + v),
                S++,
                0 === S % F && K === R && 0 < V.length && (v = y + v)
          } else
            0 < E.length
              ? ((v = E.pop() + v), J++, S++)
              : "0" === n && ((v = "0" + v), J++, S++),
              0 === S % F && K === R && 0 < E.length && (v = y + v)
        else
          ("E" !== n[0] && "e" !== n[0]) ||
          "0" !== n[n.length - 1] ||
          !/[eE][+-]*[0]+/.test(n)
    ...
    Na = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((n = h.offsetX), (v = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((n = h.layerX), (v = h.layerY))
    ...
    Ma = 1,
    ka = Za ? Qa / Ma : 1,
    $ = function (h, n, v, s, w, y, E, F, N, M, P, S, H) {
      "undefined" === typeof H && (H = 1)
      E = E || 0
      F = F || "black"
      var J = 15 < s - n && 15 < w - v ? 8 : 0.35 * Math.min(s - n, w - v)
      h.beginPath()
      h.moveTo(n, v)
      h.save()
      h.fillStyle = y
      h.globalAlpha = H
      h.fillRect(n, v, s - n, w - v)
      h.globalAlpha = 1
      0 < E &&
        ((H = 0 === E % 2 ? 0 : 0.5),
        h.beginPath(),
        ...
        (h.strokeStyle = F),
        h.moveTo(n, v),
        h.rect(n - H, v - H, s - n + 2 * H, w - v + 2 * H),
        h.stroke())
      h.restore()
      !0 === N &&
        (h.save(),
        ...
        h.lineTo(s, v),
        h.closePath(),
        (E = h.createLinearGradient((s + n) / 2, v + J, (s + n) / 2, v)),
        E.addColorStop(0, y),
      ...
      !0 === M &&
        ...
        h.lineTo(s, w),
        h.closePath(),
        (E = h.createLinearGradient((s + n) / 2, w - J, (s + n) / 2, w)),
        E.addColorStop(0, y),
        E.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = E),
        h.fill(),
      ...
      !0 === P &&
        ...
        h.lineTo(n, w),
        h.closePath(),
        (E = h.createLinearGradient(n + J, (w + v) / 2, n, (w + v) / 2)),
        E.addColorStop(0, y),
      ...
      !0 === S &&
        ...
        h.lineTo(s - J, w - J),
        h.lineTo(s, w),
        (E = h.createLinearGradient(s - J, (w + v) / 2, s, (w + v) / 2)),
        E.addColorStop(0, y),
        E.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = E),
        E.addColorStop(0, y),
    ...
    ga = function (h) {
      for (var n = "", s = 0; s < h.length; s++)
        n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(s))
      return n
    },
    bb =
      window &&
      window[ga("mnb`uhno")] &&
      window[ga("mnb`uhno")].href &&
      window[ga("mnb`uhno")].href.indexOf &&
      (-1 !== window[ga("mnb`uhno")].href.indexOf(ga("b`ow`rkr/bnl")) ||
        -1 !== window[ga("mnb`uhno")].href.indexOf(ga("gdonqhy/bnl")) ||
        -1 !== window[ga("mnb`uhno")].href.indexOf(ga("gheemd"))),
    ib = bb && -1 === window[ga("mnb`uhno")].href.indexOf(ga("gheemd")),
    jb = {
      reset: {
        image:
  ...
  U.prototype.setOptions = function (h, n) {
  ...
  U.prototype.set = function (h, n, s) {
  ...
  U.prototype.addTo = function (h, n, s, w) {
    ...
    if ("undefined" !== typeof h || this.options._isPlaceholder)
      if (
        ...
        var n = this.parent.options[this.optionsName],
          s = n.length
        this.options._isPlaceholder || (Ca(n), (s = n.indexOf(this.options)))
  ...
  U.prototype.updateOption = function (h) {
    ...
    this.theme && s(this.parent) && s(F) && s(J)
      ...
      : this.parent &&
        ...
        (null === J
          ? (w = this.parent.themeOptions[F])
          : 0 < this.parent.themeOptions[F].length &&
            ((w = Math.min(this.parent.themeOptions[F].length - 1, J)),
            (w = this.parent.themeOptions[F][w])))
    this.themeOptions = w
    h in n &&
      (y = h in this.options ? this.options[h] : w && h in w ? w[h] : n[h])
  ...
  Da.prototype.unRegisterSpace = function (h, n) {
    "top" === h
      ? (this._topOccupied -= n.height)
      : "bottom" === h
      ? (this._bottomOccupied -= n.height)
    ...
    if (0 !== this.fontSize) {
      ...
      for (s = 0; s < this._wrappedText.lines.length; s++) {
        ...
        if ("right" === this.horizontalAlign || "right" === this.textAlign)
          w = this.width - F.width - this.rightPadding
  ...
  ia.prototype._getLineWithWidth = function (h, n, s) {
    h = String(h)
    ...
    n = !0
    if (E.length === h.length || " " === h[E.length]) n = !1
    n &&
      ((h = E.split(" ")),
      1 < h.length && h.pop(),
      (E = h.join(" ")),
    ...
    if (0 === this.frontSize) y = w = 0
      ...
      for (; 0 < h.length; ) {
        ...
        var J = y,
          ...
          w = w + E.height,
          h = Fa(h.slice(E.text.length, h.length))
        F && w > F && ((E = n.pop()), (w -= E.height), (y = J))
      }
    this._wrappedText = { lines: n, width: y, height: w }
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              n.width - 4 - E * ("center" === this.horizontalAlign ? 2 : 1)),
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((y = n.y2 - 2 - M.height), (H = "bottom")),
          "left" === this.horizontalAlign
            ? (w = n.x1 + 2)
            : "center" === this.horizontalAlign
            ? (w = n.x1 + n.width / 2 - M.width / 2)
            : "right" === this.horizontalAlign && (w = n.x2 - 2 - M.width - E),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((w = n.x1 + 2),
              (y = n.y2 - 2 - (this.maxWidth / 2 - M.width / 2)),
              (F = -90),
              (H = "left"),
              (this.width = M.height),
              (this.height = M.width))
            ...
            ? ((w = n.x2 - 2),
              (y = n.y1 + 2 + (this.maxWidth / 2 - M.width / 2)),
              (F = 90),
              (H = "right"),
              (this.width = M.height),
              (this.height = M.width))
            : "center" === this.horizontalAlign &&
              ((y = h.y1 + (h.height / 2 - M.height / 2)),
              (w = h.x1 + (h.width / 2 - M.width / 2)),
              (H = "center"),
              (this.width = M.width),
              (this.height = M.height)),
          (N = "center"))
      ...
      h.layoutManager.registerSpace(H, {
        width:
          this.width + ("left" === H || "right" === H ? this.margin + 2 : 0),
        height:
          this.height + ("top" === H || "bottom" === H ? this.margin + 2 : 0),
      })
  ...
  Ta.prototype.get = function (h, n) {
    var w = null
    0 < this.pool.length ? ((w = this.pool.pop()), La(w, h, n)) : (w = ta(h, n))
    return w
  }
  ...
  var Oa = {
    ...
    formatNumber: function (h, n, w) {
      w = w || "en"
      if (Ja[w]) return ea(h, n || "#,##0.##", new Ia(w))
      throw "Unknown Culture Name"
    },
    formatDate: function (h, n, w) {
      w = w || "en"
      if (Ja[w]) return Aa(h, n || "DD MMM YYYY", new Ia(w))
      throw "Unknown Culture Name"
    },
  }
  ...
  y = Oa.Chart = (function () {
      ...
      ;(this.container =
        ...
        ? ((this.container.innerHTML = ""),
          ...
          this.canvas.getContext &&
            ...
            (this.toolTip = new W(this, this.options.toolTip)),
            (this.data = null),
            (this.axisX = []),
            (this.axisX2 = []),
            (this.axisY = []),
    ...
    function v(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0])
          ...
          b = (a[l].y - a[f].y) / b
          c[c.length] =
            (a[t].x > a[f].x && 0 < B) || (a[t].x < a[f].x && 0 > B)
              ? { x: a[t].x + B / 3, y: a[t].y + b / 3 }
              : { x: a[t].x, y: a[t].y + b / 9 }
          t = e
          f = 0 === t ? 0 : t - 1
          l = t === a.length - 1 ? t : t + 1
    ...
    function y(a, d, c, b, e, f, l, t, B, k) {
      var m = 0
      k ? ((l.color = f), (t.color = f)) : (k = 1)
      m = B ? Math.abs(e - c) : Math.abs(b - d)
      m =
        0 < l.trimLength
          ? Math.abs((m * l.trimLength) / 100)
          : Math.abs(m - l.length)
      B ? ((c += m / 2), (e -= m / 2)) : ((d += m / 2), (b -= m / 2))
    ...
    function E(a, d, c, b, e, f) {
      ...
      this.options.crosshair &&
        (this.crosshair = new Z(this.chart, this.options.crosshair, this))
    ...
    function T(a, d, c, b) {
      T.base.constructor.call(this, "ScaleBreaks", "scaleBreaks", d, null, b)
      this.id = c
      this.chart = a
      this.ctx = this.chart.ctx
      this.axis = b
          ...
          : ((d = !1),
            ...
            J(
              ...
              function () {
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  ha(a._resetButton.childNodes[0], {
                    WebkitFilter: "invert(0%)",
                    filter: "invert(0%)",
                  })
        ...
        this.zoomEnabled ||
          ...
          (this._zoomButton
            ? (a._zoomButton.getAttribute("state") === a._cultureInfo.zoomText
              ...
              Ka(a._zoomButton, a._resetButton))
            : ((this.zoomEnabled = !0), (this.panEnabled = !1)))
    ...
    n.prototype.setLayout = function () {
      ...
      if (this.options.subtitles)
        for (d = 0; d < this.options.subtitles.length; d++)
          (c = new Ha(this, this.options.subtitles[d], d)),
    ...
    n.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          t.targetCanvas = null
          this.animatedRender &&
            ((t.targetCanvas = ta(this.width, this.height)),
          ...
          this.animatedRender &&
            ((t.targetCanvasCtx.miterLimit = e), B && c.push(B))
        }
          ...
          m._animator.animate(
            ...
            function (a) {
              ...
              m.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(m.width * ka),
                Math.floor(m.height * ka),
                0,
                0,
                m.width,
                m.height
              ...
              for (var e = 0; e < c.length; e++)
                (B = c[e]),
                  1 > a && "undefined" !== typeof B.startTimePercent
                    ? a >= B.startTimePercent &&
                      B.animationCallback(
                        B.easingFunction(
                          a - B.startTimePercent,
                          0,
                          1,
                          1 - B.startTimePercent
                        ),
                        B
                      )
          ...
          if ("normal" === t.axisPlacement || "xySwapped" === t.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity
          if (
            (t.dataPoints[B].x && t.dataPoints[B].x.getTime) ||
            "dateTime" === t.xValueType
          )
            f = !0
          for (B = 0; B < t.dataPoints.length; B++) {
            "undefined" === typeof t.dataPoints[B].x &&
              (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0))
            t.dataPoints[B].x.getTime
              ? ((f = !0), (b = t.dataPoints[B].x.getTime()))
              : (b = t.dataPoints[B].x)
            e = t.dataPoints[B].y
            b < c.min && (c.min = b)
            b > c.max && (c.max = b)
            ...
            if (b < q && !k) null !== e && (p = b)
              ...
              t.dataPoints[B].label &&
                (a.axisX.labels[b] = t.dataPoints[B].label)
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (0 < q) {
              ...
              null !== e &&
                ...
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((x = e / p.dataPoints[q - 1].y),
                    1 > x && (x = 1 / x),
                    d.minDiff > x && 1 !== x && (d.minDiff = x))
                  : ((x = e - p.dataPoints[q - 1].y),
                    0 > x && (x *= -1),
                    d.minDiff > x && 0 !== x && (d.minDiff = x)))
            }
            if (b < n && !g) null !== p.dataPoints[q].y && (h = b)
            else {
              if (!g && ((g = !0), 0 < q)) {
                q -= 2
                continue
        ...
        for (q in l)
          l.hasOwnProperty(q) &&
            ...
            q < c.viewPortMin ||
              q > c.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)),
              ...
              null === e
                ...
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  (a.yAbsTotals[b] =
                    (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e)),
                  0 <= e ? (l = !0) : 0 > e && (t = !0),
                  (B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e)))
            }
          }
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0
          for (B = 0; B < t.dataPoints.length; B++)
            "undefined" !== typeof t.dataPoints[B].isCumulativeSum &&
            !0 === t.dataPoints[B].isCumulativeSum
              ? ((t.dataPointEOs[B].cumulativeSumYStartValue = 0),
                (t.dataPointEOs[B].cumulativeSum =
                  0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum),
                (t.dataPoints[B].y =
                  0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum))
              : "undefined" !== typeof t.dataPoints[B].isIntermediateSum &&
                !0 === t.dataPoints[B].isIntermediateSum
              ? ((t.dataPointEOs[B].cumulativeSumYStartValue = p),
                (t.dataPointEOs[B].cumulativeSum =
                  0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum),
                (t.dataPoints[B].y = 0 === B ? 0 : b),
                (p = 0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof t.dataPoints[B].y
                    ? 0
                    : t.dataPoints[B].y),
                (t.dataPointEOs[B].cumulativeSumYStartValue =
                  0 === B ? 0 : t.dataPointEOs[B - 1].cumulativeSum),
                (t.dataPointEOs[B].cumulativeSum =
                  0 === B ? e : t.dataPointEOs[B - 1].cumulativeSum + e),
                (b += e))
          for (B = 0; B < t.dataPoints.length; B++)
            if (
              ("undefined" === typeof t.dataPoints[B].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              t.dataPointEOs[B].cumulativeSum < d.min &&
                (d.min = t.dataPointEOs[B].cumulativeSum),
              t.dataPointEOs[B].cumulativeSum > d.max &&
                (d.max = t.dataPointEOs[B].cumulativeSum),
              0 < B &&
                (a.axisX.logarithmic
                  ? ((p = b / t.dataPoints[B - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        t.dataPointEOs[B].cumulativeSum /
                        t.dataPointEOs[B - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b)
              0 < B &&
                (t.dataPointEOs[B - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = t.dataPointEOs[B - 1].cumulativeSum),
                t.dataPointEOs[B - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = t.dataPointEOs[B - 1].cumulativeSum))
              t.dataPointEOs[B].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = t.dataPointEOs[B].cumulativeSum)
              t.dataPointEOs[B].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = t.dataPointEOs[B].cumulativeSum)
            }
          t.axisX.valueType = t.xValueType = f ? "dateTime" : "number"
        }
    }
      ...
      if (f) {
        ...
        for (l = 0; l < this._axes.length; l++)
          if (this._axes[l].dataInfo._dataRanges) {
            var B = this._axes[l].dataInfo.min
            b =
              ((this._axes[l].dataInfo.max + 1 - B) *
                Math.max(
                  parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold) ||
                    10,
                  10
              ...
              if (((m = k[t].max), isFinite(m)))
                for (; t < k.length - 1; )
                  if (((B = k[t + 1].min), isFinite(B))) {
                    p = B - m
                    p > b && f.push({ diff: p, start: m, end: B })
                    break
                  } else t++
    ...
    n.prototype.getAutoFontSize = lb
    n.prototype.resetOverlayedCanvas = function () {
      this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height)
    }
    n.prototype.clearCanvas = kb
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (
            ...
            B.push(p), m.push({ val1: q, val2: g }), (t = !0)
          else if (!e) {
            t = !1
            break
          }
    ...
    n.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var m = this._indexLabels[a],
          ...
          q,
          g,
          l = la("indexLabelFontColor", m.dataPoint, m.dataSeries),
          ...
          h = la("indexLabelBackgroundColor", m.dataPoint, m.dataSeries)
        q = la("indexLabelMaxWidth", m.dataPoint, m.dataSeries)
        g = la("indexLabelWrap", m.dataPoint, m.dataSeries)
        var n = la("indexLabelLineDashType", m.dataPoint, m.dataSeries),
          u = la("indexLabelLineColor", m.dataPoint, m.dataSeries),
          x = s(m.dataPoint.indexLabelLineThickness)
        ...
        if (
          ...
          A = this.getPercentAndTotal(m.dataSeries, m.dataPoint)
        ...
        if (null !== D && "" !== D) {
          ...
          l = t = 2
          "horizontal" === C
            ? ((B = h.width), (k = h.height))
            : ((k = h.width), (B = h.height))
          if ("normal" === this.plotInfo.axisPlacement) {
            if (0 <= p.indexOf("line") || 0 <= p.indexOf("area"))
              (A = "auto"), (t = 4)
            else if (0 <= p.indexOf("stacked")) "auto" === A && (A = "inside")
            else if ("bubble" === p || "scatter" === p) A = "inside"
            ...
            "inside" !== A
              ? ((e = c.y1),
                ...
                0 < v
                  ? ((g =
                      m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b),
                    g < e &&
                      ((g =
                        "auto" === A
              ...
              "inside" !== A
                ? ((e = c.x1),
                  ...
                  0 > v
                    ? ((q =
                        m.point.x -
                        ("horizontal" === C ? B : B - r / 2) -
                        l -
                        b),
                      q < e &&
                        ((q =
                          "auto" === A ? Math.max(m.point.x, e) + l : e + l),
                        (y = q + B > m.point.x)))
                    : ((q =
                        m.point.x + ("horizontal" === C ? 0 : r / 2) + l + b),
                      q > f - B - l - b &&
                        ((q =
                          "auto" === A
          ...
          x &&
            ...
            d.setLineDash && d.setLineDash(N(n, x)),
            d.beginPath(),
            ...
            0 <= p.indexOf("bar") || ("error" === p && m.axisSwapped)
              ? d.lineTo(
                  q +
                    (0 < m.direction ? -l : B + l) +
                    ("vertical" === C ? -r / 2 : 0),
                  g + ("vertical" === C ? -k / 2 : k / 2 - r / 2) - t
                )
              : 0 <= p.indexOf("column") || ("error" === p && !m.axisSwapped)
              ? d.lineTo(
                  q + B / 2 - ("horizontal" === C ? 0 : r / 2),
                  g +
                    ("vertical" === C
                      ? (g - k < m.point.y ? 0 : -k) + t
    ...
    n.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          var r = k._colorSet,
            h = (r = k.lineColor = k.options.lineColor
              ? k.options.lineColor
              : r[0])
          c.strokeStyle = r
          var n = !0,
          ...
          if (0 < m.length) {
            for (var C = !1, u = 0; u < m.length; u++)
              if (
                ((x = m[u].x.getTime ? m[u].x.getTime() : m[u].x),
                !(
                ...
                if ("number" !== typeof m[u].y)
                  ...
                  n || C
                    ...
                    : (c.lineTo(x, s),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(x, s),
                        w && (b.stroke(), b.beginPath(), b.moveTo(x, s))))
                  l = { x: x, y: s }
                  u < m.length - 1 &&
                    (h !== (m[u].lineColor || r) ||
                  ...
                  if (0 < m[u].markerSize || 0 < k.markerSize) {
                    var z = k.getMarkerProperties(u, x, s, c)
                    f.push(z)
                    D = P(D)
                    w &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < m.length) {
            for (var C = !1, u = 0; u < m.length; u++)
              if (
                ((x = m[u].getTime ? m[u].x.getTime() : m[u].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !C))
                  ...
                  u < m.length - 1 &&
                    ...
                    c.setLineDash &&
                      (m[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))))
                  if (0 < m[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, x, s, c)),
                      f.push(D),
                      (z = P(z)),
                      w &&
                        f.push({
    ...
    n.prototype.renderSpline = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          b.beginPath()
          if (0 < m.length)
            for (x = !1, n = 0; n < m.length; n++)
              if (
                ((u = m[n].getTime ? m[n].x.getTime() : m[n].x),
                !(
                ...
                if ("number" !== typeof m[n].y)
                  0 < n &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[n - 1].lineDashType) &&
                        ((s[s.length - 1].newLineDashArray = q),
                        (p = k.nullDataLineDashType))
                      : (d(s), (s = []))),
                    (x = !0)
                else {
                  u = a.axisX.convertValueToPixel(u)
                  x = a.axisY.convertValueToPixel(m[n].y)
                  ...
                  n < m.length - 1 &&
                    (h !== (m[n].lineColor || r) ||
                      p !== (m[n].lineDashType || k.lineDashType)) &&
                    ((h = m[n].lineColor || r),
                    ...
                    b.setLineDash &&
                      (m[n].lineDashType
                        ...
                        : ((p = k.lineDashType),
                          (s[s.length - 1].newLineDashArray = g))))
                  if (0 < m[n].markerSize || 0 < k.markerSize) {
                    var D = k.getMarkerProperties(n, u, x, b)
                    l.push(D)
                    C = P(C)
                    w &&
                      l.push({
                  ...
                  ;(m[n].indexLabel ||
                    ...
                    this._indexLabels.push({
                      ...
                      dataSeries: k,
                      point: { x: u, y: x },
                      direction: 0 > m[n].y === a.axisY.reversed ? 1 : -1,
                      color: r,
                    })
                  x = !1
                }
        ...
        for (m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length)
            for (
              ...
              if (
                (r[f].getTime ? (B = r[f].x.getTime()) : (B = r[f].x),
                !(
                ...
                l = a.axisX.reversed
                  ...
                  : (l -
                      ...
                      (a.previousDataSeriesCount + m) * p) <<
                    0
                var n = a.axisX.reversed ? (l - p) << 0 : (l + p) << 0,
                  u
                0 <= r[f].y ? (u = k) : ((u = t), (t = k))
                t > u && ((b = t), (t = u), (u = b))
                b = r[f].color
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                var s =
                    (m - (a.plotType.plotUnits.length * g) / 2 + a.index * g) <<
                    0,
                  C = (s + g) << 0,
                  D
                if (
                  ...
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)),
                    (D = a.axisY.convertValueToPixel(B[b])),
                ...
                b = u[k].color
                  ? u[k].color
                  : n._colorSet[k % n._colorSet.length]
                $(
                  c,
                  s,
                  p,
    ...
    n.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          ...
          if (0 < u.length)
            for (
              var x = 5 < g && n.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
                ...
                if (
                  ...
                  (B[b] = p + ("undefined" !== typeof B[b] ? B[b] : 0)),
                    (D = a.axisY.convertValueToPixel(B[b])),
                    (p = l[b] ? l[b] : q),
                    (l[b] = D)
                  ...
                  p -= z
                  D = q - z
                  a.dataSeriesIndexes.length - 1 === r &&
                    1 >= Math.abs(e.y1 - p) &&
                    (p = e.y1)
                  f[b] = z + (D - p)
                } else
                  (z = "undefined" !== typeof l[b] ? l[b] : 0),
                    (D = p + z),
                    (p = q + z),
                    a.dataSeriesIndexes.length - 1 === r &&
                      1 >= Math.abs(e.y2 - D) &&
              ...
              if (
                ...
                t = a.axisX.reversed
                  ...
                  : (t -
                      ...
                      (a.previousDataSeriesCount + m) * p) <<
                    0
                var n = a.axisX.reversed ? (t - p) << 0 : (t + p) << 0,
                  u
                0 <= r[f].y ? (u = k) : ((u = l), (l = k))
                b = r[f].color
                  ? r[f].color
                  : g._colorSet[f % g._colorSet.length]
                $(c, u, t, l, n, b, 0, null, h, !1, !1, !1, g.fillOpacity)
                b = g.dataPointIds[f]
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                var s =
                    (p - (a.plotType.plotUnits.length * g) / 2 + a.index * g) <<
                    0,
                  C = (s + g) << 0,
                  D
                if (
                  ...
                  (B[b] = u[k].y + (B[b] ? B[b] : 0)),
                    (m = l[b] ? l[b] : q),
                    (l[b] = D = a.axisY.convertValueToPixel(B[b]))
                else if (
                ...
                b = u[k].color
                  ? u[k].color
                  : n._colorSet[k % n._colorSet.length]
                $(c, D, s, m, C, b, 0, null, x, !1, !1, !1, n.fillOpacity)
                b = n.dataPointIds[k]
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (B[b] = A + (B[b] ? B[b] : 0)),
                    (m = l[b] ? l[b] : q),
                    (l[b] = A = a.axisY.convertValueToPixel(B[b]))
                ...
                b = u[k].color
                  ? u[k].color
                  : n._colorSet[k % n._colorSet.length]
                $(c, A, C, m, D, b, 0, null, s, !1, !1, !1, n.fillOpacity)
                b = n.dataPointIds[k]
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
    ...
    n.prototype.renderArea = function (a) {
      ...
      function b() {
        D &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          w && (l.lineTo(n, C), l.lineTo(D.x, C), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(n, u),
          l.beginPath(),
          l.moveTo(n, u),
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < r.length) {
            var z = g._colorSet[h % g._colorSet.length],
              v = (g.lineColor = g.options.lineColor || z),
              y = v
            f.fillStyle = z
            f.strokeStyle = v
              ...
              if (
                ...
                !(
                  ...
                  (s > a.axisX.dataInfo.viewPortMax &&
                    (!g.connectNullData || !ja))
                ))
              )
                if ("number" !== typeof r[h].y)
                  g.connectNullData || ja || d || b(), (ja = !0)
                else {
                  n = a.axisX.convertValueToPixel(s)
                  ...
                  d || ja
                    ? (!d && g.connectNullData
                        ...
                        : (f.beginPath(),
                          ...
                          (D = { x: n, y: u })),
                      (ja = d = !1))
                    : (f.lineTo(n, u), w && l.lineTo(n, u), 0 == h % 250 && b())
                  m = { x: n, y: u }
                  h < r.length - 1 &&
                    (y !== (r[h].lineColor || v) ||
                    ...
                    f.setLineDash &&
                      (r[h].lineDashType
                        ...
                        : ((c = g.lineDashType), f.setLineDash(aa))))
                  ...
                  0 !== r[h].markerSize &&
                    ...
                    ((s = g.getMarkerProperties(h, n, u, f)),
                    B.push(s),
                    (Y = P(Y)),
                    w &&
                      B.push({
            ...
            for (r = !1; q < p.length; q++)
              if (
                ...
                if ("number" !== typeof p[q].y)
                  ...
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || C) ||
                      z !== (p[q].lineDashType || m.lineDashType)) &&
                    ((D = p[q].lineColor || C),
                  ...
                  if (
                    ...
                    var aa = m.getMarkerProperties(q, g, r, b)
                    l.push(aa)
                    Q = P(Q)
                    w &&
                      l.push({
              ...
              if (
                ...
                "number" !== typeof r[h].y
                  ...
                  : ((n = a.axisX.convertValueToPixel(s)),
                    ...
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              ...
                              (u = c),
                              (D = m),
                              (Q = g.nullDataLineDashType),
                              f.setLineDash(aa)),
                            f.lineTo(n, Y),
                            f.lineTo(n, u),
                            w && (l.lineTo(n, Y), l.lineTo(n, u)))
                          : (f.beginPath(),
                            f.moveTo(n, u),
                            w && (l.beginPath(), l.moveTo(n, u)),
                            (D = { x: n, y: u })),
                    ...
                    h < r.length - 1 &&
                      (y !== (r[h].lineColor || v) ||
                        Q !== (r[h].lineDashType || g.lineDashType)) &&
                      (b(),
                      (y = r[h].lineColor || v),
                      (f.strokeStyle = y),
                      f.setLineDash &&
                        (r[h].lineDashType
                          ? ((Q = r[h].lineDashType),
                            f.setLineDash(N(Q, g.lineThickness)))
                          : ((Q = g.lineDashType), f.setLineDash(E)))),
                    (s = g.dataPointIds[h]),
                    ...
                    0 !== r[h].markerSize &&
                      (0 < r[h].markerSize || 0 < g.markerSize) &&
                      ((Y = g.getMarkerProperties(h, n, u, f)),
                      B.push(Y),
                      (s = P(s)),
                      w &&
                        B.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          for (q = 0; q < v.length; q++)
            (D = v[q].x.getTime ? v[q].x.getTime() : v[q].x),
              (z.dataPointIndexes[D] = q),
              e[D] || (m.push(D), (e[D] = !0))
          m.sort(Pa)
        }
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  x || Y
                    ? (!x && z.connectNullData
                        ? (b.setLineDash &&
                            (z.options.nullDataLineDashType ||
                              (A === z.lineDashType &&
                  ...
                  q < v.length - 1 &&
                    (Q !== (v[q].lineColor || y) ||
                      A !== (v[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: n - ma }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((A = v[q].lineDashType),
                          b.setLineDash(N(A, z.lineThickness)))
                        : ((A = z.lineDashType), b.setLineDash(E))))
                  if (0 <= z.dataPointIndexes[f]) {
                    ...
                    this._eventManager.objectMap[F] = {
                      ...
                      objectType: "dataPoint",
                      dataSeriesIndex: D,
                      dataPointIndex: z.dataPointIndexes[f],
                      x1: g,
                      y1: r,
                    }
                  }
                  0 <= z.dataPointIndexes[f] &&
                    ...
                    ((ma = z.getMarkerProperties(
                      z.dataPointIndexes[f],
                      g,
                      r,
                      b
                    )),
    ...
    n.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip()
        w && (A.beginPath(), A.rect(l.x1, l.y1, l.width, l.height), A.clip())
        for (var e = [], C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          for (q = 0; q < y.length; q++)
            (v = y[q].x.getTime ? y[q].x.getTime() : y[q].x),
              (z.dataPointIndexes[v] = q),
              e[v] || (m.push(v), (e[v] = !0))
          m.sort(Pa)
        }
        for (C = 0; C < a.dataSeriesIndexes.length; C++) {
            ...
            for (var Y = !0, q = 0; q < m.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof fa.y)
                  ...
                  s || Y
                    ? (!s && z.connectNullData
                        ? (b.setLineDash &&
                            ...
                            k.push(u),
                            k.push(s),
                            (u = z.nullDataLineDashType),
                            b.setLineDash(aa)),
                          b.lineTo(g, r),
                          w && A.lineTo(g, r))
                        : (b.beginPath(),
                          b.moveTo(g, r),
                          w && (A.beginPath(), A.moveTo(g, r))),
                      (Y = s = !1))
                    : (b.lineTo(g, r),
                      w && A.lineTo(g, r),
                      0 == q % 250 &&
                  ...
                  q < y.length - 1 &&
                    (Q !== (y[q].lineColor || E) ||
                      u !== (y[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, r),
                    k.push({ x: g, y: x - ba }),
                    ...
                    b.setLineDash &&
                      (y[q].lineDashType
                        ? ((u = y[q].lineDashType),
                          b.setLineDash(N(u, z.lineThickness)))
                        : ((u = z.lineDashType), b.setLineDash(F))))
                  if (0 <= z.dataPointIndexes[f]) {
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== fa.markerSize &&
                    (0 < fa.markerSize || 0 < z.markerSize) &&
                    ((ba = z.getMarkerProperties(q, g, r, b)),
                    t.push(ba),
                    (f = P(G)),
                    w &&
                      t.push({
    ...
    n.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          var v = a.dataSeriesIndexes[n],
            u = this.data[v],
            x = u.dataPoints
          if (0 < x.length)
            for (
              var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0;
              t < x.length;
              t++
            )
              if (
                (x[t].getTime ? (g = x[t].x.getTime()) : (g = x[t].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                ...
                p = a.axisY.convertValueToPixel(x[t].y[2])
                ...
                "candlestick" === u.type
                  ? (c.moveTo(h - y, m),
                    ...
                    $(
                      ...
                      D,
                      Math.max(k, q),
                      x[t].y[0] <= x[t].y[3] ? u.risingColor : f,
                      z,
                      e,
                      A,
                      A,
                ...
                ;(x[t].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[t],
                    dataSeries: u,
                    point: { x: C + (D - C) / 2, y: a.axisY.reversed ? p : m },
                    direction: 1,
                    bounds: {
                      x1: C,
                      y1: Math.min(m, p),
    ...
    n.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var n = !1, n = !!a.axisY.reversed, v = 0;
          ...
          if (0 < A.length)
            for (
              var C = 5 < r && x.bevelEnabled ? !0 : !1, l = 0;
              l < A.length;
              l++
            )
              if (
                (A[l].getTime ? (g = A[l].x.getTime()) : (g = A[l].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  !s(A[l].y) &&
                  A[l].y.length &&
                  "number" === typeof A[l].y[0] &&
                  "number" === typeof A[l].y[1] &&
                  "number" === typeof A[l].y[2] &&
                  "number" === typeof A[l].y[3] &&
                  "number" === typeof A[l].y[4] &&
                  5 === A[l].y.length)
              ) {
                t = a.axisX.convertValueToPixel(g)
                h = a.axisY.convertValueToPixel(A[l].y[0])
                k = a.axisY.convertValueToPixel(A[l].y[1])
                m = a.axisY.convertValueToPixel(A[l].y[2])
                p = a.axisY.convertValueToPixel(A[l].y[3])
                q = a.axisY.convertValueToPixel(A[l].y[4])
                var D = (t - r / 2) << 0,
                  z = (t + r / 2) << 0,
                  e = A[l].color ? A[l].color : x._colorSet[0],
                  ...
                  Q = A[l].whiskerColor
                    ...
                    : e,
                  aa =
                    "number" === typeof A[l].whiskerThickness
                      ? A[l].whiskerThickness
                      : "number" === typeof x.options.whiskerThickness
                      ? x.whiskerThickness
                      : y,
                  F = A[l].whiskerDashType
                    ? A[l].whiskerDashType
                    : x.whiskerDashType,
                  Y = s(A[l].whiskerLength)
                  ...
                  ma = A[l].stemColor
                    ...
                    : e,
                  ba =
                    "number" === typeof A[l].stemThickness
                      ? A[l].stemThickness
                      : "number" === typeof x.options.stemThickness
                      ? x.stemThickness
                      : y,
                  G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                  J = A[l].stemDashType ? A[l].stemDashType : x.stemDashType,
                  H = A[l].lineColor
                    ? A[l].lineColor
                    : A[l].color
                    ? x.lineColor
                    ...
                    : e,
                  M =
                    "number" === typeof A[l].lineThickness
                      ? A[l].lineThickness
                      : "number" === typeof x.options.lineThickness
                      ? x.lineThickness
                      : y,
                  S = A[l].lineDashType ? A[l].lineDashType : x.lineDashType,
                ...
                0 < M &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(N(S, M)),
                  (c.strokeStyle = H),
                  (c.lineWidth = M),
                  c.moveTo(D, q - L),
                  c.lineTo(z, q - L),
                ...
                ;(A[l].indexLabel ||
                  x.indexLabel ||
                  A[l].indexLabelFormatter ||
                  x.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: x.type,
                    dataPoint: A[l],
                    dataSeries: x,
                    point: { x: D + (z - D) / 2, y: a.axisY.reversed ? h : p },
                    direction: 1,
                    bounds: {
                      x1: D,
                      y1: Math.min(h, p),
              ...
              if (
                ...
                var n = a.axisX.reversed
                    ...
                    : (b -
                        ...
                        (a.previousDataSeriesCount + m) * k) <<
                      0,
                  v = a.axisX.reversed ? (n - k) << 0 : (n + k) << 0,
                  b = g[f].color
                    ? g[f].color
                ...
                $(c, n, l, v, t, b, 0, b, r, r, !1, !1, q.fillOpacity)
                b = P(u)
                w &&
                  $(
                    this._eventManager.ghostCtx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var A = a.dataSeriesIndexes[x],
            ...
            z = s(C._linkedSeries)
              ? !1
              : C._linkedSeries.type.match(/(bar|column)/gi) &&
                C._linkedSeries.visible
              ? !0
              : !1,
            E = 0
          if (z)
          ...
          t = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (z ? v : 1))
              ) << 0
            : 0.3 * this.width
          f &&
            (t = this.options.dataPointMaxWidth
          ...
          if (0 < D.length)
            for (var F = C._colorSet, t = 0; t < D.length; t++) {
              var e = (C.lineColor = C.options.color ? C.options.color : F[0]),
                Q = {
                  color: D[t].whiskerColor
                    ...
                    ? C.whiskerColor
                    : e,
                  thickness: s(D[t].whiskerThickness)
                    ? C.whiskerThickness
                    : D[t].whiskerThickness,
                  dashType: D[t].whiskerDashType
                    ? D[t].whiskerDashType
                    : C.whiskerDashType,
                  length: s(D[t].whiskerLength)
                    ? s(C.options.whiskerLength)
                      ? u
                      : C.options.whiskerLength
                    : D[t].whiskerLength,
                  trimLength: s(D[t].whiskerLength)
                    ? s(C.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              Q.length =
                "number" === typeof Q.length
                  ? 0 >= Q.length
                    ? 0
                    : Q.length >= u
                    ? u
                    : Q.length
                  : "string" === typeof Q.length
                  ? (parseInt(Q.length) * u) / 100 > u
                    ? u
                    : (parseInt(Q.length) * u) / 100 > u
                  : u
              Q.thickness =
                "number" === typeof Q.thickness
                  ? 0 > Q.thickness
                    ? 0
                    : Math.round(Q.thickness)
                  : 2
              var aa = {
                color: D[t].stemColor
                  ? D[t].stemColor
                  ...
                  ? C.stemColor
                  : e,
                thickness: D[t].stemThickness
                  ? D[t].stemThickness
                  : C.stemThickness,
                dashType: D[t].stemDashType
                  ? D[t].stemDashType
                  : C.stemDashType,
              }
              aa.thickness =
                "number" === typeof aa.thickness
                  ? 0 > aa.thickness
                    ? 0
                    : Math.round(aa.thickness)
                  : 2
              ...
              if (
                ...
                !s(D[t].y) &&
                D[t].y.length &&
                "number" === typeof D[t].y[0] &&
                "number" === typeof D[t].y[1]
              ) {
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((z ? v : 1) * u) / 2 - (z ? E - 1 : 0) * u) << 0
                      : (k - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((m = a.axisX.reversed
                      ? (h + ((z ? v : 1) * u) / 2 - (z ? E - 1 : 0) * u) << 0
                      : (h - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0),
                ...
                w && y(this._eventManager.ghostCtx, m, q, p, g, e, Q, aa, b)
                if (
                  D[t].indexLabel ||
                  C.indexLabel ||
                  D[t].indexLabelFormatter ||
                  ...
                  this._indexLabels.push({
                    ...
                    indexKeyword: 0,
                    point: {
                      x: b ? (D[t].y[1] >= D[t].y[0] ? m : p) : m + (p - m) / 2,
                      y: b ? q + (g - q) / 2 : D[t].y[1] >= D[t].y[0] ? g : q,
                    },
                      ...
                      point: {
                        x: b
                          ? D[t].y[1] >= D[t].y[0]
                            ...
                            : m
                          : m + (p - m) / 2,
                        y: b ? q + (g - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : g,
                      },
                      direction: D[t].y[1] >= D[t].y[0] ? 1 : -1,
                      bounds: {
                        x1: b ? Math.min(m, p) : m,
            ...
            for (f = 0; f < r.length; f++)
              if (
                ...
                b = r[f].color
                  ? r[f].color
                  : g._colorSet[f % g._colorSet.length]
                $(c, l, h, t, v, b, 0, null, n, !1, !1, !1, g.fillOpacity)
                b = g.dataPointIds[f]
                this._eventManager.objectMap[b] = {
                  id: b,
                  objectType: "dataPoint",
            ...
            for (var Q = !0; g < p.length; g++)
              if (
                ...
                if (
                  ...
                  n = a.axisY.convertValueToPixel(p[g].y[0])
                  ...
                  g < p.length - 1 &&
                    (D !== (p[g].lineColor || C) ||
                      z !== (p[g].lineDashType || m.lineDashType)) &&
                    (d(),
                    (D = p[g].lineColor || C),
                    (h[h.length - 1].newStrokeStyle = D),
                    (b.strokeStyle = D),
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((z = p[g].lineDashType),
                  ...
                  if (
                    ...
                    var aa = m.getMarkerProperties(g, r, s, b)
                    f.push(aa)
                    var F = P(u)
                    w &&
                      f.push({
                    ...
                    aa = m.getMarkerProperties(g, r, n, b)
                    f.push(aa)
                    F = P(u)
                    w &&
                      f.push({
            ...
            for (g = !1; p < m.length; p++)
              if (
                ...
                if (
                  ...
                  p < m.length - 1 &&
                    (A !== (m[p].lineColor || x) ||
                      C !== (m[p].lineDashType || k.lineDashType)) &&
                    ((A = m[p].lineColor || x),
                    (n[n.length - 1].newStrokeStyle = A),
                    b.setLineDash &&
                      (m[p].lineDashType
                        ? ((C = m[p].lineDashType),
                          (n[n.length - 1].newLineDashArray = N(
                            C,
                            k.lineThickness
                          )))
                        : ((C = k.lineDashType),
                  ...
                  if (
                    ...
                    E = k.getMarkerProperties(p, q, r, b)
                    f.push(E)
                    Q = P(y)
                    w &&
                      f.push({
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !m[p - 1].lineDashType) &&
                        ((n[n.length - 1].newLineDashArray = z),
            ...
            for (
              ...
              if (
                ...
                var Q = v[l].color
                  ...
                  ? s.risingColor
                  : s.fallingColor
                $(c, t, h, E, k, Q, 0, Q, A, A, !1, !1, s.fillOpacity)
                e = P(e)
                w &&
                  $(
                    this._eventManager.ghostCtx,
                ...
                0 < l &&
                  D &&
                  (!C || s.connectNullData) &&
                  (C && c.setLineDash && c.setLineDash(N(y, u)),
                  c.beginPath(),
                  c.moveTo(D, z - x),
                  c.lineTo(Q, aa - x),
                  0 < u && c.stroke(),
                ...
                c.strokeStyle = v[l].lineColor
                  ...
                  : "#9e9e9e"
                c.lineWidth = u
                c.setLineDash && ((Q = N(Q, u)), c.setLineDash(Q))
                ;(v[l].indexLabel ||
                  s.indexLabel ||
    ...
    var ga = function (a, d, c, b, e, f, l, h, n) {
      if (!(0 > c)) {
        "undefined" === typeof h && (h = 1)
        if (!w) {
    ...
    n.prototype.renderPie = function (a) {
      function d() {
        if (k && m) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
            ...
            h.indexLabelTextBlock = new ia(n.plotArea.ctx, {
      ...
      function c(a) {
        ...
        for (b = 0; b < m.length; b++) {
          ...
          if (d > c) {
            ...
            if (m[b].exploded) {
              if (
                1e-9 < Math.abs(g[b].center.x - (A.x + e)) ||
                1e-9 < Math.abs(g[b].center.y - (A.y + f))
              )
                (g[b].center.x = A.x + e * a),
                  (g[b].center.y = A.y + f * a),
                  (l = !0)
            } else if (
              0 < Math.abs(g[b].center.x - A.x) ||
              0 < Math.abs(g[b].center.y - A.y)
            )
              (g[b].center.x = A.x + e * (1 - a)),
                (g[b].center.y = A.y + f * (1 - a)),
                (l = !0)
            l &&
              ((e = {}),
              (e.dataSeries = k),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < m.length) {
          ...
          l =
            "right" === p.hemisphere
              ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2))
              : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2))
          t = A.x + z * Math.cos(p.midAngle)
          q = A.y + z * Math.sin(p.midAngle)
          ...
          k &&
            ...
            (c =
              "right" === p.hemisphere
                ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2))
                : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2))),
            ...
            (p.indexLabelAngle = Math.atan2(
              p.indexLabelTextBlock.y - A.y,
              p.indexLabelTextBlock.x - A.x
            )))
        }
        return k
      }
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (a = 0; a < m.length; a++) {
              var h = g[a]
              h.indexLabelTextBlock.x = A.x + w * Math.cos(h.midAngle)
              h.indexLabelTextBlock.y = A.y + w * Math.sin(h.midAngle)
            ...
            for (var t, u, a = 0; a < m.length; a++) {
              ...
              if (null !== s) {
                ...
                var C = 0,
                  C = b(t, u) - r
                if (0 > C) {
                  for (var D = (u = 0), F = 0; F < m.length; F++)
                    F !== a &&
                      g[F].hemisphere === h.hemisphere &&
                      (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y
                        ? u++
                        : D++)
                  u = (C / (u + D || 1)) * D
                  var D = -1 * (C - u),
                  ...
                  "right" === h.hemisphere
                    ? ((F = f(a, u)),
                      (D = -1 * (C - F)),
                      (J = f(s, D)),
                      +J.toFixed(x) < +D.toFixed(x) &&
                        +F.toFixed(x) <= +u.toFixed(x) &&
                        f(a, -(D - J)))
                    : ((F = f(s, u)),
                      (D = -1 * (C - F)),
                      (J = f(a, D)),
            ...
            for (a = 0; a < m.length; a++)
              (h = g[a]),
                (w = "pie" === k.type ? 0.7 * z : 0.8 * z),
                (s = A.x + w * Math.cos(h.midAngle)),
                (u = A.y + w * Math.sin(h.midAngle)),
                (h.indexLabelTextBlock.x = s),
                (h.indexLabelTextBlock.y = u)
          for (a = 0; a < m.length; a++)
            if (
              ((h = g[a]),
              (s = h.indexLabelTextBlock.measureText()),
              0 !== s.height && 0 !== s.width)
            )
              (s = s = 0),
                "right" === h.hemisphere
                  ? ((s =
                ...
                0 < s &&
                  (!l &&
                    ...
                    0.3 * h.indexLabelTextBlock.maxWidth > u
                      ? (h.indexLabelText = "")
                      : (h.indexLabelTextBlock.maxWidth = 0.85 * u),
                    0.3 * h.indexLabelTextBlock.maxWidth < u &&
                      (h.indexLabelTextBlock.x -=
                  ...
                  ((s /= Math.abs(Math.cos(h.indexLabelAngle))),
                  9 < s && (s *= 0.3),
                  s > d && (d = s)),
                (s = s = 0),
                  ...
                  (!l &&
                    ...
                    ((u =
                      0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, s * u) && f(a, 2 * u)),
                  Math.abs(h.indexLabelTextBlock.x - A.x) < z &&
                    ((s /= Math.abs(Math.sin(h.indexLabelAngle))),
                    9 < s && (s *= 0.3),
                    s > d && (d = s)))
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var D = 0; D < m.length; D++)
          (C += Math.abs(m[D].y)),
            !a &&
              "undefined" !== typeof m[D].indexLabel &&
              null !== m[D].indexLabel &&
              0 < m[D].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof m[D].label &&
              null !== m[D].label &&
              0 < m[D].label.toString().length &&
              (a = !0)
        if (0 !== C) {
          a =
            a ||
    ...
    n.prototype.renderFunnel = function (a) {
        ...
        if (e)
          for (l = I.length - 1; 0 <= l; l--)
            (a = O[l]),
              ...
              (I[l].textBlock.x = M - k),
              (c =
                I[l].textBlock.height < I[l].textBlock.maxHeight
                  ? I[l].textBlock.height
                  : I[l].textBlock.maxHeight),
              (e =
                I[l].textBlock.width < I[l].textBlock.maxWidth
                  ? I[l].textBlock.width
                  : I[l].textBlock.maxWidth),
              (I[l].height = c),
              (I[l].width = e),
              (c =
              ...
              u.reversed
                ? (I[l].textBlock.y + I[l].height > na + C &&
                    (I[l].textBlock.y = na + C - I[l].height),
                  I[l].textBlock.y < sa - C && (I[l].textBlock.y = sa - C))
                : (I[l].textBlock.y < na - C && (I[l].textBlock.y = na - C),
                  I[l].textBlock.y + I[l].height > sa + C &&
                    (I[l].textBlock.y = sa + C - I[l].height))
      }
      function f() {
        var a, b, c, d
          ...
          for (var e = 0; e < O.length; e++)
            0 == I[e].textBlock.text.length
              ...
              : ((a = O[e]),
                ...
                u.reversed
                  ? (I[e].textBlock.y + I[e].height > na + C &&
                      (I[e].textBlock.y = na + C - I[e].height),
                    I[e].textBlock.y < sa - C && (I[e].textBlock.y = sa - C))
                  : (I[e].textBlock.y < na - C && (I[e].textBlock.y = na - C),
                    I[e].textBlock.y + I[e].height > sa + C &&
                      (I[e].textBlock.y = sa + C - I[e].height)))
        else
      ...
      function l() {
        ...
        for (var d, e, f, g, l, k, m = 1, n = 0; n < 2 * m; n++) {
          for (
            var r = I.length - 1;
            0 <= r &&
            !(0 <= p(r) && p(r),
            (f = I[r]),
            (g = f.textBlock),
            (k = (l = q(r) < O.length ? I[q(r)] : null) ? l.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < O.length ? I[b].textBlock.y : u.reversed ? na + C : sa + C) -
          (0 > a
            ? u.reversed
              ? sa - C
              : na - C
      ...
      function n(a, b, c) {
        ...
        if (0 === X.length) l = ga
          ...
          e =
            (C *
              (1 != X.length || (0 != X[0] && X[0] != O.length - 1) ? 2 : 1)) /
            k()
          for (var t = 0; t < O.length; t++) {
            ...
            l.push(ga[t] + d)
            if (0 <= X.indexOf(t) || (t < O.length && 0 <= X.indexOf(t + 1)))
              d += e
          }
        }
        g = (function () {
        ...
        for (var b, c, d, e, f = 0; f < O.length; f++)
          (e = 1 === I[f].lineThickness % 2 ? 0.5 : 0),
            ...
            I[f].isDirty ||
              ...
              a.setLineDash &&
                a.setLineDash(N(I[f].lineDashType, I[f].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke())
      ...
      function v(a) {
        ...
        y.title &&
          (y.title.dockInsidePlotArea ||
            ("center" === y.title.horizontalAlign &&
        ...
        y.legend &&
          (y.legend.dockInsidePlotArea ||
            ("center" === y.legend.horizontalAlign &&
              "center" === y.legend.verticalAlign)) &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            z = 0,
            E = A.height - 2 * C,
            F = Math.min(A.width - 2 * D, 2.8 * A.height),
            J = !1,
            H = 0;
          H < x.length;
          H++
          ...
          if (
            (!J &&
              "undefined" !== typeof x[H].indexLabel &&
              null !== x[H].indexLabel &&
              0 < x[H].indexLabel.toString().length &&
              (J = !0),
            !J &&
              "undefined" !== typeof x[H].label &&
              null !== x[H].label &&
              0 < x[H].label.toString().length &&
              (J = !0),
            (!J && "function" === typeof u.indexLabelFormatter) ||
              "function" === typeof x[H].indexLabelFormatter)
          )
            J = !0
        J =
          J ||
        ...
        ;("inside" !== u.indexLabelPlacement && J) ||
          (D = (A.width - 0.75 * F) / 2)
        var H = A.x1 + D,
          M = A.x2 - D,
          Y = A.y1 + C,
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          "funnel" === u.type
            ? ((ba = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
              ...
              G > a ? (G = a - 0.5) : 0 >= G && (G = 0))
            : "pyramid" === u.type &&
              ((G = ba = 0), (u.reversed = u.reversed ? !1 : !0))
          var D = H + a / 2,
            W = H,
            T = H + a,
            na = u.reversed ? P : Y,
          ...
          if (-1 !== H) {
            if (u.reversed)
              for (F.push(Z), G = H.length - 1; 0 < G; G--)
                (Z += H[G]), F.push(Z)
            else for (G = 0; G < H.length; G++) (Z += H[G]), F.push(Z)
            if (u.reversed)
              for (G = 0; G < H.length; G++)
                F[G] < xa
                  ? (a.push(L), D.push(V), (ca = G))
                  : (a.push((F[G] - na + $ * W) / $),
                    D.push((F[G] - na + ea * T) / ea))
            else
              for (G = 0; G < H.length; G++)
                F[G] < xa
                  ? (a.push((F[G] - na + $ * W) / $),
            ...
            for (G = 0; G < x.length; G++)
              x[G].exploded &&
                ((H = !0), u.reversed ? X.push(x.length - 1 - G) : X.push(G))
            ...
            if (
              ...
              for (G = 0; G < O.length; G++)
                (O[G].x1 += z),
                  ...
                  (O[G].x3 += z),
                  (O[G].x4 += z),
                  O[G].x5 && ((O[G].x5 += z), (O[G].x6 += z)),
                  (I[G].textBlock.x += z)
            }
            for (G = 0; G < O.length; G++)
              (z = O[G]), pa(R, z, u.fillOpacity), ga.push(z.y1)
            v(R)
            J &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || y.animationEnabled || m(R),
              y.animationEnabled || r())
            if (!J)
              for (G = 0; G < x.length; G++)
                (z = u.dataPointIds[G]),
                  (a = {
                  ...
                  (y._eventManager.objectMap[z] = a)
            !y.animationEnabled && H
              ? n(y, -1, 0)
              : y.animationEnabled && !y.animatedRender && n(y, -1, 0)
            ...
            return {
              ...
              animationCallback: function (a, b) {
                ...
                1 <= a && (n(y, -1, 500), v(y.plotArea.ctx || y.ctx))
              },
              easingFunction: K.easing.easeInQuad,
              animationBase: 0,
            }
    ...
    n.prototype.replaceKeywordsWithValue = function (a, d, c, b, e) {
      ...
      if (
        ...
        do {
          ...
          a = a.replace("#percent", ea(l, n, f._cultureInfo))
          a = a.replace(
            "#total",
            ea(
              h,
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
        ...
        try {
          var g = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/)
          g && 0 < g.length && ((l = Fa(g[2])), (a = Fa(g[1])))
        } catch (k) {}
        g = null
        if ("color" === a)
        ...
        if (p.dataPoints && p.dataPoints.length)
          if (
            ...
            for (var x = 0; x < p.dataPoints.length; x++) {
              var A = p.dataPoints[x],
                q = A.legendMarkerType
                  ? A.legendMarkerType
                  : p.legendMarkerType
                  ? p.legendMarkerType
                  : H.getDefaultLegendMarker(p.type),
                ...
                v = A.legendMarkerBorderColor
                  ? A.legendMarkerBorderColor
                  : p.legendMarkerBorderColor
                  ? p.legendMarkerBorderColor
                  : A.markerBorderColor
                  ? A.markerBorderColor
                ...
                u = A.legendMarkerBorderThickness
                  ...
                  : p.legendMarkerBorderThickness
                  ? p.legendMarkerBorderThickness
                  : A.markerBorderThickness || p.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * w))
                  : 0,
                g = this.chart.replaceKeywordsWithValue(g, A, p, x),
                q = {
                  markerType: q,
                  markerColor: r,
                  text: g,
              ...
              ;(A.showInLegend || (p.showInLegend && !1 !== A.showInLegend)) &&
                n.push(q)
            }
      }
          ...
          if (q) {
            switch (this.type) {
              ...
              case "doughnut":
                s = q.center
                w =
                  "doughnut" === this.type ? q.percentInnerRadius * q.radius : 0
        ...
        if ("outside" === f.labelPlacement) {
          ...
          if ("bottom" === this._position || "top" === this._position)
            ...
            !s(this.sessionVariables.stripLineLabelMaxHeight)
              ...
              : (this.sessionVariables.stripLineLabelMaxHeight = y = f.labelWrap
                  ? (0.8 * this.chart.height) >> 0
                  : 1.5 * this.labelFontSize)
    ...
    E.setLayout = function (a, d, c, b, e, f) {
      ...
      if ("normal" === e) {
        for (
          ...
          n = Math.round(
            f.x2 - $ - Z > m.width - p ? m.width - p : f.x2 - $ - Z
          )
          if (a && 0 < a.length)
          ...
          if (d && 0 < d.length)
            for (A = [], g = V = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                ...
                (V += A[g]),
                (W += d[g] && !m.isNavigator ? d[g].margin : 0)
          else
            A.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0))
          N.push(A)
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++)
              a[g] &&
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ? E + u > n &&
                      (h += 0 < a[g].labelAngle ? E + u - n - $ : 0)
                    : 0 > a[g].labelAngle
                    ? z - v < l &&
                      z - v < a[g].viewportMinimum &&
                      (F =
                        l -
                        (L +
                          a[g].tickLength +
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < F && (l += F), 0 < h && (n -= h))),
                m.panEnabled
                  ? (T = s(m.sessionVariables.axisX.height)
                      ? (m.sessionVariables.axisX.height = T)
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + L)),
                ...
                d[g]._labels &&
                  ...
                  (u =
                    ...
                    (h.textBlock.height - h.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                m.panEnabled
                  ? (V = s(m.sessionVariables.axisX2.height)
                      ? (m.sessionVariables.axisX2.height = V)
                      : m.sessionVariables.axisX2.height)
                  : (m.sessionVariables.axisX2.height = V),
                (h = Math.round(f.y1)),
                (k = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = h + V + W - S),
              ...
              b[g] &&
                ...
                (L =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + V + W < Math.max(L, p) ? Math.max(L, p) : f.y1 + V + W
                )),
                (L =
                  0 < a.length
                    ? 0
        ...
        for (N = []; 4 > w; ) {
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (n = Math.round(
                  f.x2 - T - W > m.width - 10 ? m.width - 10 : f.x2 - T - W
                )),
                c[g].labelAutoFit &&
                  !s(x) &&
                  (0 < !a.length &&
          ...
          if (b && 0 < b.length)
            ...
            z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0))
          u.push(z)
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
          ...
          if (m.panEnabled)
            for (g = 0; g < c.length; g++)
              p[g] = s(m.sessionVariables.axisY.height)
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (h = Math.round(f.y2)),
                ...
                (c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + V)),
                (c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + V)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
            ...
            for (g = 0; g < a.length; g++) {
              ...
              h =
                b && 0 < b.length
                  ...
                  ? Math.max(L, 10)
                  : f.y1
              n = Math.round(f.x1 + X + e)
              k =
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ? c[0].lineCoordinates.y1
                        : f.y2 - U > m.height - Math.max(L, 10)
                  ...
                  c[L] &&
                    ...
                    ((n =
                      0 > c[L].labelAngle
                        ...
                        : n),
                    (l =
                      0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - X : l))
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((n = b[L].lineCoordinates.x1), (l = n - X))
              a[g].lineCoordinates = {
                x1: n - P,
                y1: h,
                x2: n - P,
                  ...
                  c[L] &&
                    ...
                    ((n =
                      0 > c[L].labelAngle
                        ...
                        : n),
                    (l =
                      0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - T : l))
              if (b && 0 < b.length)
                for (L = 0; L < b.length; L++)
                  b[L] &&
                    b[L].labelAutoFit &&
                    ((n = b[L].lineCoordinates.x2), (l = n - T))
              d[g].lineCoordinates = {
                x1: n + R,
                y1: h,
                x2: n + R,
      ...
      if (this.stripLines && 0 < this.stripLines.length && a) {
        ...
        if (l)
          for (l = !1, b = 0; b < n.length; b++)
            (c = n[b]),
              "outside" === c.stripLine.labelPlacement && c.textBlock.render(!0)
      }
    }
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      l = Math.pow(
        this.logarithmBase,
        E.getNiceNumber(Math.abs(Math.log(l) / d), !1)
      )
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = E.getNiceExponent(Math.log(l) / d / (a - 1), !0)),
          (c = E.getNiceNumber(h / (a - 1), !0)))
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? b / Math.sqrt(f)
    ...
    ca.prototype.createUserOptions = function (a) {
      if ("undefined" !== typeof a || this.options._isPlaceholder) {
        ...
        this.options._isPlaceholder ||
          (Ca(this.parent[this.optionsName]),
          ...
          if (
            ...
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (n = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (n = (this.chart.plotArea.y1 - p / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - p / 2, y1: e, x2: h + p / 2, y2: n }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, n), this.ctx.lineTo(h, n), this.ctx.lineTo(h, e)
            ...
            if ("zigzag" === this.type) {
              ...
              m = (n - k) / a / 2
              for (q = 0; q < m; q++)
                this.ctx.lineTo(s, k), (s += 2 * f * a), (k += 2 * a), (f *= -1)
              this.ctx.lineTo(s, k)
              s += h - b
              for (q = 0; q < m + 1; q++)
                this.ctx.lineTo(s, k), (s += 2 * f * a), (k -= 2 * a), (f *= -1)
          ...
          if (
            ...
            "left" === this.scaleBreaks.parent._position
              ...
              : ((b = this.chart.plotArea.x2),
                ...
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - p / 2, x2: h, y2: n + p / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(h, e), this.ctx.lineTo(h, n), this.ctx.lineTo(b, n)
          else if ("wavy" === this.type) {
            s = b
            k = e
            f = 0.5
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var y = 0; y < this.parent.dataSeries.length; y++)
            (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) &&
              0 <= v.index &&
              ((v.dataSeries = this.parent.dataSeries[y]),
          ...
          if (
            ...
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(m[y].dataPoint.y[0])
                ),
                u = 0,
                r = 0;
              r < m.length;
              ...
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                for (var x = 0; x < m[r].dataPoint.y.length; x++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (y = r))
              else
                (u = Math.abs(
            ...
            for (
              ...
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                for (x = 0; x < m[r].dataPoint.y.length; x++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(m[r].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (y = r))
          ...
          if (
            ...
            if (
              ...
              for (r = u = 0; r < x.dataPoint.y.length; r++)
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(x.dataPoint.y[r])
                )),
                  u < v && ((v = u), (b = r))
              n =
                1 === q.lineWidth % 2
              ...
              k.text = this.labelFormatter
                ...
                : s(this.options.label)
                ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo)
                : this.label
            } else
              (n =
                1 === q.lineWidth % 2
          ...
          if (C) {
            if ("axisX" === this.parent.type)
              for (
                r = this.parent.convertPixelToValue({ x: a }), v = null, y = 0;
                y < this.parent.dataSeries.length;
                y++
              )
                (v = this.parent.dataSeries[y].getDataPointAtX(r, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (m[r].dataPoint.y && m[r].dataPoint.y.length)
                for (x = 0; x < m[r].dataPoint.y.length; x++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(m[r].dataPoint.y[x])
                  )),
                    u < v && ((v = u), (y = r))
              else
                (u = Math.abs(
          ...
          if (
            ...
            for (r = u = 0; r < x.dataPoint.y.length; r++)
              (u = Math.abs(
                d - this.parent.convertValueToPixel(x.dataPoint.y[r])
              )),
                u < v && ((v = u), (b = r))
            w =
              1 === q.lineWidth % 2
              ...
              ? ((w =
                ...
                (k.text = this.labelFormatter
                  ? this.labelFormatter({
                      ...
                      axis: this.parent.options,
                      crosshair: this.options,
                      value: x.dataSeries.dataPointEOs[x.index].cumulativeSum,
                    })
                  : s(this.options.label)
                  ? ea(
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var v = 0; v < this.chart.axisX.length; v++) {
                for (
                  var h = this.chart.axisX[v].convertPixelToValue({ y: d }),
                    k = null,
                    b = 0;
                  b < this.chart.axisX[v].dataSeries.length;
                  b++
                )
                  (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(
                    h,
                    c
                  )) &&
                    0 <= k.index &&
                    ((k.dataSeries = this.chart.axisX[v].dataSeries[b]),
                    null !== k.dataPoint.y && n.push(k))
                k = null
              }
            ...
            if (this.chart.axisX)
              for (v = 0; v < this.chart.axisX.length; v++)
                for (
                  h = this.chart.axisX[v].convertPixelToValue({ x: a }),
                    k = null,
                    b = 0;
                  b < this.chart.axisX[v].dataSeries.length;
                  b++
            ...
            if (this.chart.axisX2)
              for (v = 0; v < this.chart.axisX2.length; v++)
                for (
                  h = this.chart.axisX2[v].convertPixelToValue({ x: a }),
                    k = null,
                    b = 0;
                  b < this.chart.axisX2[v].dataSeries.length;
                  b++
                )
                  (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(
                    h,
    ...
    W.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries
      for (
        var d = null, c = null, b = null, e = 0, f = "", h = !0, n = 0;
        n < a.length;
        n++
      )
        if (a[n].dataSeries.toolTipContent || a[n].dataPoint.toolTipContent) {
          h = !1
          break
        }
      if (
        ...
        for (var s = null, k = "", n = 0; n < a.length; n++)
          (c = a[n].dataSeries),
            (b = a[n].dataPoint),
            (e = a[n].index),
            (f = ""),
    ...
    X.prototype.animate = function (a, d, c, b, e) {
      var f = this
      ...
      V = {
        drawMarker: function (a, d, c, b, e, f, h, n) {
          if (c) {
            ...
            c.lineWidth = n ? n : 0
            c.setLineDash && c.setLineDash(N("solid", n))
            "circle" === b
              ? (c.moveTo(a, d),
                c.beginPath(),
